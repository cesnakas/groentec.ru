			...
			<div id="elementContainer" class="column">
				<div class="mainContainer" id="browse">
					...
					<div class="secondCol col<?if(empty($arResult["PREVIEW_TEXT"]) && empty($arResult["SKU_OFFERS"]) && empty($arResult["PROPERTIES"])):?> hide<?endif;?>">
						...
						<div class="tovar_price_calculator_form">

      						<div class="calculator_string">
								<div class="calculator_string_name">Длина покрытия (см):</div>
								<div class="calculator_value">
									<input type="text" class="area_count js-item_dlina" value="">
								</div>
							</div>

      						<div class="calculator_string">
								<div class="calculator_string_name">Ширина покрытия (см):</div>
								<div class="calculator_value">
									<input type="text" class="area_count js-item_shirina" value="">
								</div>
							</div>

							<div class="calculator_string calculator_string--flex">
								<div class="calculator_string_name">Зазор (мм):</div>
								<div class="calculator_value">
									<select class="area_count js-item_zazor">
							...
							<div class="calculator_string calculator_string--flex">
								<div class="calculator_string_name">Укладка досок:</div>
								<div class="calculator_value">
									<select class="area_count js-item_ukladka">
										<option value="1">по длине покрытия</option>
										<option value="2">по ширине покрытия</option>
									</select>
								</div>
							</div>
      						<div class="calculator_string">
								<div class="calculator_string_name">Площадь м<sup>2</sup>:</div>
								<div class="calculator_value">
									<span class="js-item_square">0</span>
								</div>
							</div>

							<div class="calculator_string">
                                <div class="calculator_string_name js__item-price" data-price="<?=$arResult["PROPERTIES"]["PRICE_M2"]["VALUE"]?>" data-price_type="1">Цена за 1 м<sup>2</sup>:</div>
              					<div class="calculator_value calculator_value_first"><?=CCurrencyLang::CurrencyFormat($arResult["PROPERTIES"]["PRICE_M2"]["VALUE"], $arResult["EXTRA_SETTINGS"]["CURRENCY"], true)?></div>
      						</div>

							<div class="calculator_string">
								<div class="calculator_string_name">В одной упаковке:</div>
								<div class="calculator_value">
									<span class="js-item_unit_square"><?=$arResult["PROPERTIES"]["KOLICHESTVO_UPK"]["VALUE"]?></span> шт
								</div>
							</div>

							<div class="calculator_string">
								<div class="calculator_string_name">Количество упаковок:</div>
								<div class="calculator_value">
									<div class="packing_count_field_wrapper">
										<!-- <input type="text" class="packing_count_field spinner_wrapper js-item_count ui-spinner-input" value="1" aria-valuemin="1" aria-valuenow="1" autocomplete="off" role="spinbutton"> -->

										<span class="ui-spinner">
											<a class="minus ui-spinner-down" tabindex="-1" role="button"></a>
											<input type="text" class="qty packing_count_field" value="1" data-step="<?=$arResult["EXTRA_SETTINGS"]["BASKET_STEP"]?>" data-max-quantity="<?=$arResult["CATALOG_QUANTITY"]?>" data-enable-trace="<?=(($arResult["CATALOG_QUANTITY_TRACE"] == "Y" && $arResult["CATALOG_CAN_BUY_ZERO"] == "N") ? "Y" : "N")?>">
											<a class="plus ui-spinner-up" tabindex="-1" role="button"></a>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="calculator_string">
								<div class="calculator_string_name">Сумма заказа:</div>
								<div class="calculator_value">
									<span class="allSum js-item_add_summ"><?=round($arResult["PRICE"]["RESULT_PRICE"]["BASE_PRICE"]*str_replace(",", ".", $arResult["PROPERTIES"]["UPAK_METRS"]["VALUE"]),2)?></span> руб.
								</div>
							</div>

							<div class="calculator_string">
								<div class="calculator_string_name min_order" style="font-weight:700;">Минимальный заказ - одна упаковка</div>
							</div>
						</div>
